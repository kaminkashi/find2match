...
$(document).ready(function () {
    $('#searchForm').submit(function (event) {
        ...
        const searchDeceased = $('#searchDeceased').val();

        // Make an AJAX request to the server
        $.ajax({
            type: 'GET',
            url: '/search_d',
            data: { Deceased: searchDeceased },
            success: function (data) {
                if (data.error) {
                        ...
                        ul.append(`
                            <li class="${isSameName ? 'green-user' : 'normal-user'}">
                                ...
                                <div class="user-details">
                                    <span>${matchingUser.firstName} (${matchingUser.Deceased})</span>
                    ...
                    displayErrorMessage(`No matching users found for ${searchDeceased}.`);
                }
            },
